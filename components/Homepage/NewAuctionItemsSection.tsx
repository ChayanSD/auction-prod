...
const NewAuctionItemsSection: React.FC = () => {
  ...
  return (
    <div className="w-full min-h-[500px] sm:min-h-[600px] lg:h-auto lg:min-h-[1168px] bg-gradient-to-br from-orange-50 to-amber-50 pb-0 pt-16 md:pt-0 md:pb-20 md:rounded-b-2xl lg:-mt-90 xl:-mt-100 2xl:-mt-110">
