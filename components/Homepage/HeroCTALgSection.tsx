...
const HeroCTALgSection: React.FC = () => {
  ...
  return (
    <section className="relative pointer-events-auto lg:top-[-370px] xl:top-[-400px] lg:max-w-[945px] xl:max-w-[1240px] 2xl:max-w-[1240px] h-[528px] mx-auto rounded-[32px] bg-[linear-gradient(305deg,#9F13FB_14.33%,#E95AFF_95.9%)] p-[80px]">
      {/* Main container with gap */}
      <div className="flex items-end justify-between h-full gap-[29px]">
        
        {/* Left Character Card - Babi Mario */}
        <div className="flex-shrink-0 w-auto">
          <div className="relative bg-white/10 backdrop-blur-sm border border-white/50 w-[180.70492276303258px] h-[197.76228028926388px] pt-[17px] pr-[16px] pb-[17px] pl-[16px] rounded-[20px] rotate-[3.28deg] flex flex-col gap-[10px]">
            <Image 
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center text-white px-8 self-center">
          ...
          {/* CTA Button */}
          <button onClick={() => router.push('/request-to-list')} className="flex items-center cursor-pointer space-x-2 border-2 border-white/50 bg-white/10 backdrop-blur-sm text-white font-semibold px-6 py-3 rounded-full hover:bg-white/20 transition-colors">
        ...
        <div className="flex-shrink-0 w-auto self-start">
          <div className="relative bg-white/10 backdrop-blur-sm border border-white/50 w-[173.274916514957px] h-[205.5062395548405px] pt-[17px] pr-[16px] pb-[17px] pl-[16px] rounded-[20px] -rotate-[12.69deg] flex flex-col gap-[10px]">
            <Image 
              src="/Superman.png" 
              alt="Superman" 
              fill
