...
/**
 * Mobile and tablet Hero CTA section
 * Optimized for screens below 1024px
 */
const HeroCTASection: React.FC = () => {
  ...
  return (
    <section className={`relative ${isHomepage ? 'lg:top-[-370px] xl:top-[-400px]' : ''} ${isAuctionpage ? 'lg:top-[190px] xl:top-[180px]' : ''} z-50 lg:max-w-[945px] xl:max-w-[1240px] md:rounded-t-[32px] lg:rounded-[32px] bg-[linear-gradient(305deg,#9F13FB_14.33%,#E95AFF_95.9%)] mx-auto`}>
      <div className="flex flex-col md:flex-row items-center md:items-end pt-6 sm:pt-8 md:pt-4 px-4 sm:px-6">
        {/* Left Content */}
        <div className="text-white md:px-12 lg:px-20 pb-4 sm:pb-6 md:pb-4 items-center md:items-start text-center md:text-left w-full md:w-auto">
          <div className="inline-block mb-4 sm:mb-6">
            <span className="rounded-[140px] border border-[rgba(255,255,255,0.5)] bg-[rgba(255,255,255,0.25)] px-4 sm:px-[18px] py-1.5 sm:py-2 text-xs sm:text-sm">
              Listing Invitations
            </span>
          </div>

          <div>
            <h2 className="text-2xl sm:text-3xl md:text-[30px] xl:text-5xl font-bold mb-4 sm:mb-6 leading-tight">
              List your products for auction
            </h2>
            <p className="text-sm sm:text-base lg:text-[16.9px] xl:text-xl text-white/90 mb-6 sm:mb-8 leading-relaxed max-w-lg mx-auto md:mx-0">
          ...
          <div className="flex justify-center md:justify-start">
            <button className="flex items-center space-x-2 border text-white font-semibold px-5 sm:px-6 py-2.5 sm:py-3 rounded-full shadow-lg transition-colors text-sm sm:text-base hover:bg-white/10">
        ...
        <div className="w-full md:w-auto flex justify-center md:justify-end -mb-4 md:-mb-4 mt-4 md:mt-0">
          <img 
            className="w-full max-w-[200px] sm:max-w-[250px] md:max-w-none h-auto md:-mb-4" 
            src="/image 69.png" 
