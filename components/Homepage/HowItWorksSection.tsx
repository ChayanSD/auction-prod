        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-6 xl:gap-8 relative z-10">
            {steps.map((step, index) => (
              ...
              >
                {/* Premium Card */}
                <div className="bg-white rounded-[32px] border border-gray-100 p-6 sm:p-8 lg:p-10 shadow-sm hover:shadow-xl transition-all duration-300 h-full flex flex-col relative overflow-hidden group-hover:border-purple-200">
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                    {/* Icon */}
                    <div className="mb-4 sm:mb-6 text-purple-600 group-hover:text-purple-700 transition-colors">
                    ...
                    {/* Title */}
                    <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-3 sm:mb-4 group-hover:text-gray-950 transition-colors">
                      {step.title}
                    </h3>

                    {/* Description */}
                    <p className="text-sm sm:text-base lg:text-lg text-gray-600 leading-relaxed flex-1">
                      {step.description}
                    </p>
                  </div>
