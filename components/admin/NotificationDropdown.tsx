...
export default function NotificationDropdown() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-3 w-80 sm:w-96 bg-white rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.1)] border border-gray-100 overflow-hidden z-50 animate-in fade-in zoom-in-95 duration-200">
          ...
          <div className="p-3 border-t border-gray-100 bg-gray-50/80 text-center">
            <Link
              href="/cms/pannel/notifications"
              className="text-sm font-bold text-[#9F13FB] hover:text-[#8e11e0] transition-colors block w-full py-2 bg-white rounded-lg border border-[#9F13FB]/10 shadow-sm active:scale-95"
            >
