...
const ProductDetails: React.FC<ProductDetailsProps> = ({
  ...
  // Check both item's endDate (if available) and auction's endDate
  const itemEndDate = (item as any).endDate ? new Date((item as any).endDate) : null;
  const auctionEndDate = item.auction?.endDate ? new Date(item.auction.endDate) : null;
